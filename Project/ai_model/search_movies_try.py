...
def load_data():
    # Load movie metadata
    with open("ai_model/data/movies.json", "r", encoding="utf-8") as f:
        movies = json.load(f)
    ...
    # Load FAISS index
    index = faiss.read_index("ai_model/embeddings/movie_embeddings.faiss")
    
    # Load movie ID mapping
    with open("ai_model/embeddings/movie_ids.json", "r", encoding="utf-8") as f:
        movie_ids = json.load(f)
    
    # Load emotion encodings
    with open("ai_model/data/emotion_encodings.json", "r", encoding="utf-8") as f:
        emotion_encodings = json.load(f)
    
    # Load genre encodings
    with open("ai_model/data/genre_encodings.json", "r", encoding="utf-8") as f:
        genre_encodings = json.load(f)
    
    # Load genre mapping
    with open("ai_model/data/genre_mapping.json", "r", encoding="utf-8") as f:
